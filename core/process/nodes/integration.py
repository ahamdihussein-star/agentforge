...
class FileOperationNodeExecutor(BaseNodeExecutor):
    ...
    async def _generate_document_markdown(
        ...
        _data_quality_rules = (
            ...
            "  SPECIFIC numbers showing both values side by side (e.g., 'Actual: 13,333.75 vs Expected: 63,000').\n"
            ...
            "  A matched record can still have findings/anomalies.\n"
            "- 'Unmatched' means NO counterpart was found — either the reference is missing/N/A,\n"
            "  or the reference was not found in the other data set. An unmatched record is NOT matched.\n"
            "- If a record has no reference number (empty, null, 'N/A', or 'None'), it is UNMATCHED.\n"
            "- matchedCount + unmatchedCount MUST equal totalCount. Verify this before writing.\n"
            ...
            "- For EACH item with findings/anomalies/issues, list every finding individually with:\n"
            "  1. The finding type/name\n"
            "  2. The classification/severity level\n"
