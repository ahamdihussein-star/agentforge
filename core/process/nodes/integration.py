...
class FileOperationNodeExecutor(BaseNodeExecutor):
    ...
    async def _generate_document_markdown(
        ...
        _data_quality_rules = (
            ...
            "- 'Matched' means a record was successfully matched to its counterpart,\n"
            "  even if anomalies/findings were detected. 'Matched' and 'Has Findings' are NOT mutually exclusive.\n"
            "- 'Unmatched' means no counterpart was found (missing reference, no match in system).\n"
