    ...
    async def execute(
        ...
        if _is_analysis:
            _combined_system += (
                ...
                "  3. Flag ANY difference — even small ones — as a discrepancy with the exact values from both sides.\n"
                ...
                "- NEVER say 'no issues' or 'matched' unless you have verified EVERY field and number.\n"
